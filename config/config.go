	...
	if !GlobalConfig.init {
		...
		if !GlobalConfig.init {
			if PROD {
				...
				UNISWAPV2_FACTORIES := []common.Address{QUICKSWAP_FACTORY_ADDRESS, SUSHISWAP_FACTORY_ADDRESS, DFYN_FACTORY_ADDRESS, POLYCAT_FACTORY_ADDRESS, MESHSWAP_FACTORY_ADDRESS}
				...
				UNISWAPV2_ROUTER02S := []common.Address{QUICKSWAP_ROUTER02_ADDRESS, SUSHISWAP_ROUTER02_ADDRESS, DFYN_ROUTER02_ADDRESS, POLYCAT_ROUTER02_ADDRESS, MESHSWAP_ROUTER02_ADDRESS}
