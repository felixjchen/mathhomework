	...
	if !GlobalConfig.init {
		...
		if !GlobalConfig.init {
			if PROD {
				...
				FIREBIRD_FACTORY_ADDRESS := common.HexToAddress("0x5De74546d3B86C8Df7FEEc30253865e1149818C8")

				UNISWAPV2_FACTORIES := []common.Address{SUSHISWAP_FACTORY_ADDRESS, QUICKSWAP_FACTORY_ADDRESS, DFYN_FACTORY_ADDRESS, FIREBIRD_FACTORY_ADDRESS}
