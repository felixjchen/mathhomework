	...
	if !GlobalConfig.init {
		...
		if !GlobalConfig.init {
			if PROD {
				...
				FIREBIRD_FACTORY_ADDRESS := common.HexToAddress("0x5De74546d3B86C8Df7FEEc30253865e1149818C8")  // Polygon
				POLYCAT_FACTORY_ADDRESS := common.HexToAddress("0x477Ce834Ae6b7aB003cCe4BC4d8697763FF456FA")

				UNISWAPV2_FACTORIES := []common.Address{SUSHISWAP_FACTORY_ADDRESS, QUICKSWAP_FACTORY_ADDRESS, DFYN_FACTORY_ADDRESS, FIREBIRD_FACTORY_ADDRESS, POLYCAT_FACTORY_ADDRESS}
